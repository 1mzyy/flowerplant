    ...
    return (
        <div className={styles.plantCard}>
            <h3 className={styles.plantName}>
                {plant.commonName} 
                <span className={styles.scientificName}>({plant.scientificName})</span>
            </h3>
            ...
            <div className={styles.actions}>
                {/* FIXED: Use '/update/:id' to match your route */}
                <Link to={`/update/${plant.id}`} className={styles.editButton}>
                    Edit
                </Link>
                <button
